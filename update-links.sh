...
echo  "<tr><td>$TRAVIS_BRANCH</td><td>$TRAVIS_COMMIT</td><td>$TRAVIS_COMMIT_MESSAGE</td><td><img src=\"./Resources/$TRAVIS_TEST_RESULT.svg\" /></td><td><a href="./TestResults/$TRAVIS_COMMIT/report.html">Test report</a></td></tr>" >> links.html
